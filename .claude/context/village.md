...
| Projects | A long job split into tasks a house can take (never be given). Events belong to a project and show a 📋 chip in the calendar. Finished stays visible. Off the bottom bar, a tile on the map. |
