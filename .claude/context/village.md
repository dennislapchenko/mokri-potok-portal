...
| Projects | A long job split into tasks a house takes, or is handed by the task's creator after agreeing in person. Events belong to a project and show a 📋 chip in the calendar. Finished stays visible. Off the bottom bar, a tile on the map. |
| Campground | The village parking spot on park4night. A row says who collected from which camper, and a note — no amounts, no plates. Held until handed over. Everyone hears a collection. |
