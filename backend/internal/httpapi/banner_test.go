...
func TestNotificationBanners(t *testing.T) {
	...
	cases := []struct {
		...
		{"alarm", "POST", "/api/events",
			map[string]any{"title": "Medved pri koših", "kind": "alarm", "starts_at": "2026-09-04T21:00", "notes": "zaprite kokoši"},
			[2]string{"🚨 Medved pri koših", "danes ob 21:00 — zaprite kokoši"},
			[2]string{"🚨 Medved pri koših", "today at 21:00 — zaprite kokoši"}},
		{"away", "POST", "/api/away",
