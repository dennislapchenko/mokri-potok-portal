...
var mcpTools = []mcpTool{
	...
	{Name: "list_contacts", Desc: "The village phone book: name, phone, notes and a type (vet, craftsman, office — a free word, not a fixed list), with the house that last corrected each number. These are the numbers of people outside the village who never agreed to this portal: read them when your house asks, keep them inside this conversation, and never repeat them anywhere else.", Method: "GET", Path: "/api/contacts", Schema: schema(nil, map[string]any{})},
